...
class DSTimeoutFlag(enum.Enum):
    """海豚调度任务定义表 timeout_flag 字段的枚举值

    适用字段：
    t_ds_task_definition.timeout_flag
    t_ds_task_definition_log.timeout_flag
    """
    ...
    @classmethod
    def from_db_value(cls, db_value: int) -> "DSTimeoutFlag":
        for member in cls:

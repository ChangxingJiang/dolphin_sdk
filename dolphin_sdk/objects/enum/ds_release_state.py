...
class DSReleaseState(enum.Enum):
    """海豚调度的上线状态

    适用字段：
    t_ds_process_definition.release_state

    适用表单：
    projects/{project_code}/process-definition/{process_code}/release
    """
    ...
    @classmethod
    def from_db_value(cls, db_value: int) -> "DSReleaseState":
        for member in cls:
